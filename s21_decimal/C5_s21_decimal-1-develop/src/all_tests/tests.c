...
START_TEST(test_div_5) {
  int res = 0;
  s21_decimal a = {{10.0e3, 0, 0, 0}};
  s21_decimal b = {{2.00e2, 0, 0, 0}};
  s21_decimal c;
  s21_div(a, b, &c);
  s21_from_decimal_to_int(c, &res);
...
START_TEST(test_div_10) {
  ...
  ck_assert_int_eq(s21_long_mantissa_ten_times(&a), 0);
}
END_TEST
...
Suite *example_create() {
  ...
  tcase_add_test(tcase_dtoi, from_decimal_to_int_3);
  tcase_add_test(tcase_dtoi, from_decimal_to_int_4);
  tcase_add_test(tcase_dtoi, from_decimal_to_int_5);
  tcase_add_test(tcase_dtoi, from_decimal_to_int_6);
  ...
  tcase_add_test(tcase_ftod, from_float_to_decimal_10);
  tcase_add_test(tcase_ftod, from_float_to_decimal_11);
  tcase_add_test(tcase_ftod, from_float_to_decimal_12);
  tcase_add_test(tcase_ftod, from_float_to_decimal_13);
  tcase_add_test(tcase_ftod, from_float_to_decimal_14);
  tcase_add_test(tcase_ftod, from_float_to_decimal_15);
  tcase_add_test(tcase_ftod, from_float_to_decimal_16);
  tcase_add_test(tcase_ftod, from_float_to_decimal_17);
  tcase_add_test(tcase_ftod, from_float_to_decimal_18);
  tcase_add_test(tcase_ftod, from_float_to_decimal_19);
  tcase_add_test(tcase_ftod, from_float_to_decimal_20);
  tcase_add_test(tcase_ftod, from_float_to_decimal_21);
  tcase_add_test(tcase_ftod, from_float_to_decimal_22);
  tcase_add_test(tcase_ftod, from_float_to_decimal_23);
  tcase_add_test(tcase_ftod, from_float_to_decimal_24);
  tcase_add_test(tcase_ftod, from_float_to_decimal_25);
  tcase_add_test(tcase_ftod, from_float_to_decimal_26);
  tcase_add_test(tcase_ftod, from_float_to_decimal_27);
